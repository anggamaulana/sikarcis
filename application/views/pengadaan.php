...
<p class="style1">PENGADAAN BARANG / KARCIS </p>
<table width="200" border="1" bordercolor="#000000">
  ...
  <tr>
    ...
    <td><input name="bus_besar_bundel" type="text" id="bus_besar_bundel" size="20" value="<?php echo set_value('bus_besar_bundel');?>"/></td>
  </tr>
  <tr>
    <td>Bus Sedang </td>
    ...
    <td><input name="bus_sedang_bundel" type="text" id="bus_sedang_bundel" size="20" value="<?php echo set_value('bus_sedang_bundel');?>"/></td>
  </tr>
  <tr>
    <td>Truk Besar </td>
    ...
    <td><input name="truk_besar_bundel" type="text" id="truk_besar_bundel" size="20" value="<?php echo set_value('truk_besar_bundel');?>"/></td>
  </tr>
  <tr>
    <td>Truk Sedang </td>
    ...
    <td><input name="truk_sedang_bundel" type="text" id="truk_sedang_bundel" size="20" value="<?php echo set_value('truk_sedang_bundel');?>"/></td>
  </tr>
  <tr>
    <td>Truk Gandeng </td>
    ...
    <td><input name="truk_gandeng_bundel" type="text" id="truk_gandeng_bundel" size="20" value="<?php echo set_value('truk_gandeng_bundel');?>"/></td>
  </tr>
  <tr>
    <td>Sepeda Motor </td>
    ...
    <td><input name="sepeda_motor_bundel" type="text" id="sepeda_motor_bundel" size="20" value="<?php echo set_value('sepeda_motor_bundel');?>"/></td>
  </tr>
  <tr>
    <td>Mobil</td>
    ...
    <td><input name="mobil_bundel" type="text" id="mobil_bundel" size="20" value="<?php echo set_value('mobil_bundel');?>"/></td>
  </tr>
  <tr>
    <td>Sepeda</td>
    ...
    <td><input name="sepeda_bundel" type="text" id="sepeda_bundel" size="20" value="<?php echo set_value('sepeda_bundel');?>"/></td>
  </tr>
</table>
<p>&nbsp;</p>
<p><strong>Pengadaan Untuk Bulan</strong> 
